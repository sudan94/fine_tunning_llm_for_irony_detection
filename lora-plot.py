...
file_model1_hp1 = "training-evaluation-results/binary/evaluation_distillbert_set1_lora.csv"
file_model1_hp2 = "training-evaluation-results/binary/evaluation_distillbert_set2_lora.csv"
file_model2_hp1 = "training-evaluation-results/binary/evaluation_flant5_set1_lora.csv"
file_model2_hp2 = "training-evaluation-results/binary/evaluation_flant5_set2_lora.csv"
file_model3_hp1 = "training-evaluation-results/binary/evaluation_bert_set1_lora.csv"
file_model3_hp2 = "training-evaluation-results/binary/evaluation_bert_set2_lora.csv"

# uncomment the following lines for multi-class classification and comment the above lines

file_model1_hp1 = "training-evaluation-results/multi-class/evaluation_distillbert_set1_lora.csv"
file_model1_hp2 = "training-evaluation-results/multi-class/evaluation_distillbert_set2_lora.csv"
file_model2_hp1 = "training-evaluation-results/multi-class/evaluation_flant5_set1_lora.csv"
file_model2_hp2 = "training-evaluation-results/multi-class/evaluation_flant5_set2_lora.csv"
file_model3_hp1 = "training-evaluation-results/multi-class/evaluation_bert_set1_lora.csv"
file_model3_hp2 = "training-evaluation-results/multi-class/evaluation_bert_set2_lora.csv"
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Training and Validation Loss for Hyperparameter Set 1 - LoRA')
plt.legend()
plt.grid(True)
plt.show()
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Training and Validation Loss for Hyperparameter Set 2 - LoRA')
plt.legend()
plt.grid(True)
plt.show()
...
plt.title('Accuracy and F1-score for Hyperparameter Set 1 - LoRA')
plt.legend()
plt.grid(True)
plt.show()
...
plt.xlabel('Epoch')
plt.ylabel('Accuracy / F1-score')
plt.title('Accuracy and F1-score for Hyperparameter Set 2 - LoRA')
plt.legend()
plt.grid(True)
plt.show()